...
function getInfoTemplate(){
  return {
    ...
    //  "<div style=display:inline-block;width:8px;></div>"+
      "<div style=padding-top: 10px;><b>Causa:</b> ${ARCGIS.DBO.%view_tiempo_order_po_3_1_1.causa}<br></div>"+
    //  "<div style=display:inline-block;width:8px;></div>"+
      "<div style=padding-top: 10px;><b>Comentario:</b> ${ARCGIS.DBO.%view_tiempo_order_po_3_1_1.comentario}<br></div>"+
  //    "<div style=display:inline-block;width:8px;></div>"+
      "<div style=padding-top: 10px;><b>Estado:</b> ${ARCGIS.DBO.%view_tiempo_order_po_3_1.estado_orden}<br></div>"+
  //    "<div style=display:inline-block;width:8px;></div>"+
      "<div style=padding-top: 10px;><b>Fecha Creación:</b> ${ARCGIS.DBO.%view_tiempo_order_po_3_1_1.fecha_creacion:DateFormat(datePattern:'dd MM yyyy')}<br></div>"+
  //    "<div style=display:inline-block;width:8px;></div>"+
      "<div style=padding-top: 10px;><b>Fecha Asignación:</b> ${ARCGIS.DBO.%view_tiempo_order_po_3_1_1.fecha_asignacion:DateFormat(datePattern:'dd/MM/yyyy')}<br></div>"+
  //    "<div style=display:inline-block;width:8px;></div>"+
      "<div style=padding-top: 10px;><b>Fecha Despacho:</b> ${ARCGIS.DBO.%view_tiempo_order_po_3_1.fecha_despacho:DateFormat(datePattern:'dd/MM/yyyy')}<br></div>"+
  //    "<div style=display:inline-block;width:8px;></div>"+
      "<div style=padding-top: 10px;><b>Fecha Ruta:</b> ${ARCGIS.DBO.%view_tiempo_order_po_3_1.fecha_ruta:DateFormat(datePattern:'dd/MM/yyyy')}<br></div>"+
  //    "<div style=display:inline-block;width:8px;></div>"+
  ...
  //    "<div style=display:inline-block;width:8px;></div>"+
      "<div style=padding-top: 10px;><b>Estado:</b> ${ARCGIS.DBO.%view_tiempo_order_po_3_1.estado_orden}<br></div>"+
  //    "<div style=display:inline-block;width:8px;></div>"+
      "<div style=padding-top: 10px;><b>Fecha Creación:</b> ${ARCGIS.DBO.%view_tiempo_order_po_3_1.fecha_creacion:DateFormat(datePattern:'dd/MM/yyyy')}<br></div>"+
  //    "<div style=display:inline-block;width:8px;></div>"+
      "<div style=padding-top: 10px;><b>Fecha Asignación:</b> ${ARCGIS.DBO.%view_tiempo_order_po_3_1.fecha_asignacion:DateFormat(datePattern:'dd/MM/yyyy')}<br></div>"+
  //    "<div style=display:inline-block;width:8px;></div>"+
      "<div style=padding-top: 10px;><b>Fecha Despacho:</b> ${ARCGIS.DBO.%view_tiempo_order_po_3_1.fecha_despacho:DateFormat(datePattern:'dd/MM/yyyy')}<br></div>"+
  //    "<div style=display:inline-block;width:8px;></div>"+
      "<div style=padding-top: 10px;><b>Fecha Ruta:</b> ${ARCGIS.DBO.%view_tiempo_order_po_3_1.fecha_ruta:DateFormat(datePattern:'dd/MM/yyyy')}<br></div>"+
